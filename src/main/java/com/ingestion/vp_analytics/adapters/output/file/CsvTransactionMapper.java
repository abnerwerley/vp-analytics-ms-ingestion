...
public class CsvTransactionMapper {
    ...
    public Transaction map(final String[] row, final String clientId) {
        final LocalDate firstPurchase = !row[7].trim().isEmpty() ? LocalDate.parse(row[7].trim(), DATE_FORMAT) : null;
